...
EXPECTED_ASSET_SLUG = "nyu-ed-classification"
EXPECTED_VERSION_CALL = (
    "nyu_ed_classification.get_nyu_ed_classification_package_version()"
)
...
def main() -> None:
    ...
    macro_path = ROOT / "macros" / "get_nyu_ed_classification_package_version.sql"
